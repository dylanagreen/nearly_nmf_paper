This folder contains jupyter notebooks and scripts necessary to reproduce the plots in the Nearly-NMF paper (link TBD). The following index describes which notebook is linked to which plot:
